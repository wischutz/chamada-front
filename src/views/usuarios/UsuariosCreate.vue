    ...
    <div class="row">
        <form>
            ...
            <div class="mb-3">
                ...
                <input type="password" v-model="usuario.senha" class="form-control" id="senha">
            </div>
            <div class="mb-3">
                <label for="tipo" class="form-label">Tipo</label>
                <select name="tipo" id="tipo" v-model="usuario.tipo" class="form-control">
...
export default{
    ...
    methods:{
        async salvar(){
            this.usuario.roles = [this.usuario.tipo]
            delete this.usuario.tipo
            
            await this.$store.dispatch('usuario/create', {
